class JogoAlquimia {
    constructor() {
        ...
        this.combinacoes = {
            ...
            "terra,ar,ouroboros": {
                mensagem: "Trindade Elemental Despertada! 🌍🌪️🐍",
                efeito: () => this.revelarCaminho("mandala"),
            },
        };
    ...
    mostrarDicaCombinacao(chave) {
        ...
        document.getElementById("legendaAlquimia").innerHTML = `Dica: Combine ${dica} para revelar novos caminhos!`;
    }
